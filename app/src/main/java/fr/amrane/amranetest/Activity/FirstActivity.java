...
import fr.amrane.amranetest.account.activity.ListModel;
import fr.amrane.amranetest.utils.ListAdapter;
...
public class FirstActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] foods = {"Amrane", "test", "Simona Rasytinyte", "Hamada", "Wow", "Amine"};
